...
document.addEventListener('keydown', function(e) {
    if(e.keyCode === 37 && snake.dx === 0){ // left
        snake.dx = -grid;
        snake.dy = 0
    } else if(e.keyCode === 38 && snake.dy === 0){ // top
        snake.dy = -grid;
        snake.dx = 0
    } else if(e.keyCode === 39 && snake.dx === 0){ // right
        snake.dx = grid;
        snake.dy = 0
    } else if(e.keyCode === 40 && snake.dy === 0){ // back
        snake.dy = grid;
        snake.dx = 0
    } else {
        return;
